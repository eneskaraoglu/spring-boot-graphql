-- t_customer tablosuna örnek veri ekleme
INSERT INTO t_customer (customer_id, customer_name, customer_code, customer_address, customer_amount, customer_type) 
VALUES 
...
(20, 'Isabella Rogers', 'IR020', '1717 Maplelane St', 700, 2);

-- t_inventory tablosuna örnek veri ekleme
INSERT INTO t_inventory (inventory_id, inventory_name, inventory_code, inventory_amount, inventory_type, inventory_price, customer_id) 
VALUES 
...
(120, 'Monitor', 'INV120', 18, 2, 229.99, 20);
